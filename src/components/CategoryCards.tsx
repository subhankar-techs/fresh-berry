      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          ...
          <div className="flex flex-wrap items-center space-x-4 mt-4 md:mt-0">
            <button className="text-blue-600 hover:underline">All</button>
            <span className="text-gray-400">/</span>
            <button className="text-gray-600 hover:text-blue-600">Snack & Spices</button>
            <span className="text-gray-400">/</span>
            <button className="text-gray-600 hover:text-blue-600">Fruits</button>
            <span className="text-gray-400">/</span>
            <button className="text-gray-600 hover:text-blue-600">Vegetables</button>
          </div>
        </div>
